...
TEST_CASE("1 : Constructeurs")
{
  ...
  SECTION("6 : Carburant")
  {
    Carburant carb1, carb2(carb1), carb3("Tatol",10);
    REQUIRE(carb1.get_prix() == carb2.get_prix());
    REQUIRE(carb3.get_marque() == "Tatol");
    REQUIRE(carb3.get_prix() == 10);
  }
...
TEST_CASE("2 : Partie de jeu")
{
  ...
  {
    // fonctions de la classe Joueur a tester

    // voir si le budget est bien maj tous les 3 tours
  }

  SECTION("2 : Au niveau du plateau")
  {
    // Verifier que les cases (leur proprio) sont bien maj
